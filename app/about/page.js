...
const AboutUs = () => {
  return (
    <>
      <section>
        <div className="container max-w-5xl mx-auto mt-32 lg:my-32 px-4">
          <h1 className="text-5xl lg:text-7xl text-center my-4">Our Story</h1>
          ...
          <p className="md:text-xl mb-4">What sets Sea Moss Wellness apart?</p>
          <p className="md:text-xl mb-4">
      ...
      <section>
        <div className="container max-w-5xl mx-auto my-14 px-4">
          <div className="md:grid grid-cols-2 gap-x-14">
            ...
            />
            <div>
              <h2 className="text-3xl mb-4 mt-8 md:mt-0">Meet the Founder</h2>
              <p className="md:text-xl mb-4">

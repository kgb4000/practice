    ...
    <>
      <section>
        <div className="container max-w-9xl mx-auto lg:px-0 mt-20 md:mt-36 mb-16 px-4">
          ...
          <h2 className="text-2xl my-8">Order Processing Time:</h2>
          <ul className="ml-8">
            <li className="lg:text-xl mb-4 list-disc">
          ...
          <h2 className="text-2xl my-8">Shipping Methods and Timeframes:</h2>
          <ul className="ml-8">
            <li className="lg:text-xl mb-4 list-disc">
          ...
          <h2 className="text-2xl my-8">Shipping Rates:</h2>
          <ul className="ml-8">
            <li className="lg:text-xl mb-4 list-disc">
          ...
          <h2 className="text-2xl my-8">Order Tracking:</h2>
          <ul className="ml-8">
            <li className="lg:text-xl mb-4 list-disc">
          ...
          <h2 className="text-2xl my-8">International Shipping:</h2>
          <ul className="ml-8">
            <li className="text-xl mb-4 list-disc">
              We currently do not offer international shipping.
            </li>
          </ul>
          <h2 className="text-2xl my-8">Shipping Restrictions:</h2>
          <ul className="ml-8">
            <li className="lg:text-xl mb-4 list-disc">
          ...
          <h2 className="text-2xl my-8">Shipping Address Accuracy:</h2>
          <ul className="ml-8">
            <li className="lg:text-xl mb-4 list-disc">
          ...
          <h2 className="text-2xl my-8">Delivery Issues:</h2>
          <ul className="ml-8">
            <li className="lg:text-xl mb-4 list-disc">
          ...
          <h2 className="text-2xl my-8">Contact Us:</h2>
          <ul className="ml-8">
            <li className="lg:text-xl mb-4 list-disc">
          ...
          <p className="lg:text-xl mb-4">We appreciate your business!</p>

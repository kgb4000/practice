    ...
    <>
      <section>
        <div className="container max-w-9xl mx-auto lg:px-0 mt-20 md:mt-36 mb-16 px-4">
          <h1 className="text-4xl my-8 text-center">Refund Policy</h1>
          ...
          <h2 className="text-2xl mb-4">1. Return Eligibility Window</h2>
          <p className="lg:text-xl mb-4">
            We have a 90-day return policy, which means you have 90 days after
            receiving your item to request a refund.
          </p>
          <h2 className="text-2xl mb-4 ">2. Condition of Returned Items</h2>
          <p className="lg:text-xl mb-4">
          ...
          <h2 className="text-2xl mb-4 ">3. Non-Refundable Items</h2>
          <p className="lg:text-xl mb-4">
            Certain types of items cannot be returned for a refund, such as gift
            cards and downloadable products.
          </p>
          <h2 className="text-2xl mb-4 ">4. Return Process</h2>
          <p className="lg:text-xl mb-4">
          ...
          <h2 className="text-2xl mb-4 ">5. Refunds</h2>
          <p className="lg:text-xl mb-4">
          ...
          <h2 className="text-2xl mb-4 ">6. Late or Missing Refunds</h2>
          <p className="lg:text-xl mb-4">
          ...
          <h2 className="text-2xl mb-4 ">7. Exchanges</h2>
          <p className="lg:text-xl mb-4">
          ...
          <h2 className="text-2xl mb-4 ">8. Customer Service Contact</h2>
          <p className="lg:text-xl mb-4">

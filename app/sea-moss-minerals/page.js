...
const SeaMossMinerals = () => {
  return (
    <>
      <section>
        <div className="container max-w-5xl mx-auto mt-48 lg:mt-40 px-8">
          <h1 className="text-3xl lg:text-7xl text-center my-4">
        ...
        <div className="container max-w-5xl mx-auto   px-8">
          <div className="grid-top">
            <div>
              <h2 className="text-3xl py-4">What is Sea Moss?</h2>
              <p className="text-xl py-4 leading-6">
            ...
            <div>
              <h2 className="text-3xl py-4">What are Minreals?</h2>
              <p className="py-4 leading-6">

    ...
    <>
      <section>
        <div className="container max-w-3xl mx-auto my-40">
          ...
          <p className="text-xl mb-4">
            We provide our website, including all information, tools, and
          ...
          <p className="text-xl mb-4">
            By using our site and/or making a purchase, you engage in our
            “Service” and agree to be bound by these Terms of Service (“Terms”),
            including additional terms and conditions and policies referenced
            herein and/or available by hyperlink.
          </p>
          <p className="text-xl mb-4">
            These Terms apply to all site users, including browsers, vendors,
            customers, merchants, and content contributors.
          </p>
          <p className="text-xl mb-4">
            Read these Terms carefully before using our website. By using any
            part of the site, you agree to these Terms.
          </p>
          <p className="text-xl mb-4">
            If you disagree with the terms, you must not access the website or
            use our services. These Terms are considered an offer, and
            acceptance is expressly limited to these Terms.
          </p>
          <p className="text-xl mb-4">
            We may update these Terms by posting changes to our website. It’s
          ...
          <p className="text-xl mb-4">
            You must not use our products for illegal or unauthorized purposes
          ...
          <p className="text-xl mb-4">
            Reproduction, duplication, copying, selling, reselling or
          ...
          <p className="text-xl mb-4">
            ...
            accurately. We cannot guarantee the accuracy of your computer
            monitor's display.
          </p>
          <p className="text-xl mb-4">
          ...
          <p className="text-xl mb-4">
            Use of optional tools is entirely at your own risk and discretion,
          ...
          <p className="text-xl mb-4">
            Third-party links on our site are not affiliated with us. We are not
          ...
          <p className="text-xl mb-4">
            ...
            may use them without restriction or obligation to compensate or
            respond.
          </p>
          <p className="text-xl mb-4">
          ...
          <p className="text-xl mb-4">
            ...
            the site, is the property of Sea Moss Wellness or its suppliers and
          ...
          <p className="text-xl mb-4">
            ...
            a dispute cannot be resolved by negotiation, it shall be submitted
          ...
          <p className="text-xl mb-4">
            ...
            inability to access or use the Services; any conduct or content of
            any third party on the Services; any content obtained from the
            Services; and unauthorized access, use or alteration of your
          ...
          <p className="text-xl mb-4">
            ...
            unethical purposes, including harassment, abuse, defamation, or
            spreading hate speech, is strictly prohibited. Users are responsible
          ...
          <p className="text-xl mb-4">
            ...
            contact us at{' '}
            <span className="underline">support@seamosswellness.com</span>.
          </p>
        </div>
      </section>
    </>
